...
# Main entry point
# ===========================
$projectFile = "MediaLib\MediaLib.csproj"
...
try {
    ...
    $output = Join-Path -Path $currentLocation -ChildPath "MediaLib\bin\"
    ...
    # Create the release
    & $dotnet publish "MediaLib.sln" -p:PublishProfile=MediaLib/Properties/PublishProfiles/FolderProfile
